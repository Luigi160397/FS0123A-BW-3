...
const SidebarCard = () => {
    ...
    return (
        <>
            {profile && (
                <Card className="mt-3 bg-dark text-white position-relative border-0 mb-3 text-center">
                    ...
                    <Card.Body className="position-relative mt-4">
                        ...
                        <Card.Text className="fs-6 mb-0 text-muted border-secondary border-bottom pb-2"><small>{profile.title}</small></Card.Text>
                        <Card.Text className=" mb-0">
                            <div className="d-flex justify-content-between fw-bold pt-2">
                                <div>
                                    <Card.Text className='text-muted mb-0 text-start' style={{fontSize:"12px"}}>Collegamenti</Card.Text>
                                    <p className="mb-1" style={{fontSize:"12px"}}>Espandi la tua rete</p>
                                </div>
                            ...
                            <div className="d-flex justify-content-between fw-bold border-secondary border-bottom pb-2">
                                <div>
                                    <Card.Text className='text-muted mb-0 text-start' style={{fontSize:"12px"}}>Chi ha visitato il tuo profilo?</Card.Text>
                                </div>
                                <Link style={{ color: "#70b5f9", fontSize:"12px" }} className="text-decoration-none" to={"/profile"}>
                                    15
                                </Link>
